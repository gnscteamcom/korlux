        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <h2 class="">Anda telah berhasil melakukan pemesanan dengan rincian sebagai berikut :</h2><br><br>
                </div>
            </div>
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    Nomor Order : <strong>{{ $order->invoicenumber }}</strong>
                </div>
            </div>            <div class="row">
                            ...
                            <div class="col-sm-12">
                                <table class="table">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                <td class="vert-align">{{ $order_detail->product->product_name }}</td>
                                            ...
                                            <tr>
                                                <td class="vert-align"></td>
                                                <td class="vert-align"></td>
                                                <td class="vert-align text-right"><b>Biaya pengiriman {{ $order->shipment_method }}</b></td>
                                            ...
                                            <tr>
                                                <td class="vert-align"></td>
                                                <td class="vert-align"></td>
                                                <td class="vert-align text-right"><b>Biaya Packing</b></td>
                                            ...
                                            <tr class="color-red" style="font-size: 14">
                                                <td class="vert-align"></td>
                                                <td class="vert-align"></td>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="row"></div>
                    <b style="color:blue, font-size: 14">
                    Mohon dalam 24 jam, segera lakukan pembayaran ke :<br>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="row"></div>
                    Sertakan nomor invoice <strong>{{ $order->invoicenumber }}</strong> dalam catatan saat melakukan pembayaran.<br>
                    ...
                    <b style="color:red">**Jika dalam 24 jam, konfirmasi pembayaran tidak dilakukan, maka kami akan membatalkan pesanan anda.</b><br><br>
                    Best Regards,<br>
