...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Import Produk</h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="panel-body">
                <a href="{{ URL::to('downloadproductformat') }}">
        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="{{ URL::to('importproduct') }}" enctype="multipart/form-data" class="form-horizontal">
                        {!! csrf_field() !!}
