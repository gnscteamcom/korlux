...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Penjualan Reseller Step 2</h1>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="{{ URL::to('submitresellersales') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <label for="inisial">Kode Invoice</label>
                                    </div>
                                    <div class="col-lg-6">
                                        @if($cart_data)
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <label for="marketing">Nama Reseller</label>
                                        <input type="hidden" name="id_reseller" value="{{ $cart_data->options->reseller }}" />
                                        <input type="hidden" name="status_id_reseller" value="{{ $cart_data->options->status_id_reseller }}" />
                                    </div>
                                    <div class="col-lg-6">
                                        @if($cart_data)
                                        {!! $cart_data->options->nama_reseller !!}
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <label for="inisial">Username Reseller</label>
                                    </div>
                                    <div class="col-lg-6">
                                        @if($cart_data)
                                        {!! $cart_data->options->username_reseller !!}
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <label for="nama_depan">Status Reseller</label>
                                    </div>
                                    <div class="col-lg-6">
                                        @if($cart_data)
                                        {!! $cart_data->options->status_reseller !!}
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <label for="hp">HP Reseller</label>
                                    </div>
                                    <div class="col-lg-6">
                                        @if($cart_data)
                                        {!! $cart_data->options->hp_reseller !!}
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <label for="hp">Email Reseller</label>
                                    </div>
                                    <div class="col-lg-6">
                                        @if($cart_data)
                                        {!! $cart_data->options->email_reseller !!}
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <label for="marketing">Nama Pembeli</label>
                                    </div>
                                    <div class="col-lg-6">
                                        @if($cart_data)
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <label for="inisial">HP Pembeli</label>
                                    </div>
                                    <div class="col-lg-6">
                                        @if($cart_data)
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <a class="btn btn-warning btn-success col-lg-12" href="{{ URL::to('resellersales') }}"/>Kembali dan Ulang</a>
                            </div>
                            <div class="col-lg-6">
