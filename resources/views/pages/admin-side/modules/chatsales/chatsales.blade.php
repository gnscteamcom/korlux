...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Penjualan Chat</h1>
        </div>
    </div>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="{{ URL::to('manualsales') }}">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <input type="hidden" name="link_pembayaran" id="link_pembayaran" value="1" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control" readonly="readonly" id="biaya_kirim_text" name="biaya_kirim_text" />
                                    <input type="hidden" id="biaya_kirim" name="biaya_kirim" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div>
                                    <label for="nominal_unik">Nominal Unik</label>
                                    @if($cart_data != null)
                                    <input type="text" class="form-control" name="nominal_unik" maxlength="250" value="{{ $cart_data->options->nominal_unik }}" readonly/>
                                    @else
                                    <input type="text" class="form-control" name="nominal_unik" maxlength="250" value="{{ rand(0, 400) }}" readonly/>
                                    @endif
                                </div>
                            </div>
                        </div>
